...
import 'package:soccer/pages/setup/GameSetup.dart';
...
void main() {
  // https://www.woolha.com/tutorials/dart-using-and-retrieving-metadata-annotation
  // https://stackoverflow.com/questions/51169706/flutter-reflection-with-reflectable-working-example-needed/51174186
  // but command doesn't work:
  //    flutter packages pub run build_runner build linux
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        SearchForm.route: (context) => SearchForm(),
        DataForm.route: (context) => DataForm(),
        LoadResults.route: (context) => LoadResults(),
        PracticeMain.route: (context) => PracticeMain(),
        GameMain.route: (context) => GameMain(),
        CaptainList.route: (context) => CaptainList(),
        PositionSelector.route: (context) => PositionSelector(),
        CommunicationListScreen.route: (context) => CommunicationListScreen(),
        CommunicationMain.route: (context) => CommunicationMain(),
        AddCommunicationScreen.route: (context) => AddCommunicationScreen(),
        CommunicationItemScreen.route: (context) => CommunicationItemScreen(),
      },
    );
  }
}
